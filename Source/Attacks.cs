...
internal class Attacks {
    ...
    private string _1_DivinationFreeZone = "[1]Divination Free Zone"; //Spin 3 options in a circle, will deactivate it's state
    ...
    private string _8_DivinationFreeZone_EndLessLoop = "[8]Divination Free Zone_EndLessLoop";
    ...
    private string _16_DivinationJumpKicked = "[16]Divination JumpKicked";
